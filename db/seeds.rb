...
Preamble.create(text:"lookin real slick")
Preamble.create(text:"keep on keepin on")
Preamble.create(text:"an inspiration to us all")
Preamble.create(text:"don't let anyone dull your sparkle")
Preamble.create(text:"the world needs more like you")
Preamble.create(text:"never change")
Preamble.create(text:"always a pleasure")
Preamble.create(text:"keep on truckin")
...
Butan.create(text:"hit me again")
Butan.create(text:"moar")
Butan.create(text:"say something nice")
Butan.create(text:"again")
Butan.create(text:"yeah")
Butan.create(text:"great")
Butan.create(text:"oh, ok")
Butan.create(text:"keep em coming")
